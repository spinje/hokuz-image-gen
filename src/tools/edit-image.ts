...
Unsupported combinations (model x resolution / aspect ratio / provider-only option) are rejected before any image is loaded or any API call is made with an error naming the supported values. No silent downgrades.
